<x-admin-layout title="List Data" menu="listdata">
    <x-slot name="header">
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0">Data List Data</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('dashboard')}}">Beranda</a></li>
                <li class="breadcrumb-item active">Daftar List Data</li>
            </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </x-slot>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6">
                  <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                      <span class="info-box-text">Jenis Kategori</span>
                      <span class="info-box-number">
                        {{ count(list_kategori())}}
                      </span>
                    </div>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                      {{-- <a class="dropdown-item text-primary" href="{{ url('/penduduk/'.Crypt::encryptString($item->penduduk_id))}}"><i class="fas fa-list"></i> Detail Penduduk</a> --}}
                                                        <button type="button" data-toggle="modal" data-kategori="{{ $item->kategori }}" data-nama="{{ $item->nama }}" data-keterangan="{{ $item->keterangan }}"  data-id="{{ $item->id }}" data-target="#ubah" title="" class="dropdown-item text-success" data-original-title="Edit Task">
