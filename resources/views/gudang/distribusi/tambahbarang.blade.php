                                ...
                                <div class="card-body">
                                   ...
                                   <form action="{{ url('distribusi/'.$distribusi->id) }}" method="post">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="text" name="harga_beli" id="rupiah" class="form-control" value="{{ $barang->harga_beli }}">
                                        </div>
                                       <div class="form-group">
                                            <label for="">Harga Jual</label>
                                            <input type="text" name="harga_jual" id="rupiah1" class="form-control" value="{{ $barang->harga_jual }}">
                                        </div>
                                       <div class="form-group">
