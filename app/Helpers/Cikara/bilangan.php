...
if (! function_exists('filternominal')) {
    function filternominal($nominal)
    {
        $result = TRUE;
        $regex = "/[a-z,@#$%^&*!]/";
        if (preg_match($regex, $nominal)) {
            $result = FALSE;
        }
        return $result;
    }
...
// nama negara
if (! function_exists('cikararesetrupiah')) {
    function cikararesetrupiah($nilai)
    {
